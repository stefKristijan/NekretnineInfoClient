...
import com.kstefancic.potresnirizik.BuildingDetailsActivity;
        ...
        for (int i = 0; i < locations.size(); i++) {
            ...
            /*if (i == 0) {
                ...
                for (int j = 0; j < i; j++) {
                    ...
                    if ((location.getStreetNumber() + String.valueOf(location.getStreetChar())).equals(existingLoc.getStreetNumber() + String.valueOf(existingLoc.getStreetChar()))) {
                        numExists = true;
                    }
