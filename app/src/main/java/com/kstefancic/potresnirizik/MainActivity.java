...
import com.kstefancic.potresnirizik.LoginAndRegister.LoginActivity;
...
import static com.kstefancic.potresnirizik.LoginAndRegister.LoginActivity.FIRST_LOGIN;
import static com.kstefancic.potresnirizik.LoginAndRegister.LoginActivity.USER;
import static com.kstefancic.potresnirizik.helper.GetDataService.FINISH;
import static com.kstefancic.potresnirizik.views.BuildingAdapter.UPDATE_BUILDING_RQST;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void setExplorer() {
        if(mUser.getLastName()!=null && mUser.getFirstName()!=null)
            this.tvExplorer.setText(this.tvExplorer.getText()+" "+mUser.getFirstName()+" "+mUser.getLastName());
        else{
            this.tvExplorer.setText(this.tvExplorer.getText()+" "+mUser.getUsername());
        }
    }
    ...
    private void setUpActivity() {
        ...
        this.tvExplorer = findViewById(R.id.acMain_tvExplorer);
